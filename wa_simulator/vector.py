...
#             return self[0]
#         except IndexError:
#             raise Exception('Vector :: x element does not exist. Exitting...')
#
#     @x.setter
#     def x(self, value):
...
#             return self[1]
#         except IndexError:
#             raise Exception('Vector :: y element does not exist. Exitting...')
#
#     @y.setter
#     def y(self, value):
...
#         except IndexError:
#             raise Exception(
#                 'WAVector :: y element does not exist. Exitting...')
#
#     @property
#     def z(self):
...
#         except IndexError:
#             raise Exception(
#                 'WAVector :: z element does not exist. Exitting...')
#
#     @z.setter
#     def z(self, value):
